dealsList = [
    { "date": "2.7.25",
       "intro": "A Great Deal On a High Quality Cooling Pillow",
      "title": "The TEMPUR-Cloud Dual Cooling Pillow by Tempur-Pedic - Queen",
      "normalprice": "$189.00",
      "dealprice": "$82.99",
      "description": "Tempur-pedic's memory foam manages to be more supportive than everyone else's. Tempur-Pedic is actually one of the few brands than has figured out how to make a cooling pillow cover that works more often than not. This pillow has an internal gel layer meant to prevent heat from building up under the pillow's surface to begin with. If you sleep hot, this might be a good investment for you, especially at this price point.",
      "see": "/cooling",
      "link": "https://amzn.to/3YUEhNo"},
    { "date": "2.7.25",
       "intro": "A Good Deal On an Incredibly Soft, High Quality Memory Foam Pillow",
      "title": "The Symphony Memory Foam Pillow by Tempur-Pedic - Standard",
      "normalprice": "$69.87",
      "dealprice": "$53.99",
       "description": "Tempur-pedic's memory foam is a cut above. It manages to be both softer and more supportive than its countless imitators. When you open it up you can feel its substance. It just has more weight to it than other pillows. If you looking for a luxurious sleeping experience - and you don't sleep hot or need extra structure - this is a great deal on a really comfortable pillow.",
      "see": "/memory-foam",
      "link": "https://amzn.to/3Q90C5S"},
    {"date": "2.7.25",
      "intro": "A Discount on an Astonishingly Fluffy Down Alternative Pillow:",
      "title": "Bedsure Down Alternative Pillows (Queen)(set of 2)",
      "normalprice": "$24.99",
      "dealprice": "$19.99",
      ...
      {"date": "1.28.25",
      "intro": "A Discount on One of the Best Pillows for When Money is No Object:",
      "title": "The Purple Harmony Pillow",
      "normalprice": "$199.00",
      "dealprice": "$179.10",
    ...
    {"date": "1.28.25",
      "intro": "A Good Deal on a Luxurious Memory Foam Pillow:",
      "title": "Tempurpedic Symphony Pillow",
      "normalprice": "$69.87",
      "dealprice": "$53.99",
      "description": "If you're looking for a good memory foam pillow and don't sleep hot or have neck or muscle issues, you should consider the Tempurpedic Symphony pillow. Somehow, Tempurpedic just seems to make a better quality of foam. This is a good deal on a version that is a bit softer than a number of the brand's other offerings.",
      "see": "/memory-foam",
      "link": "https://amzn.to/4hsSnOl"},
    {"date": "1.26.25",
